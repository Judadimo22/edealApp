...
class SliderUsd extends StatefulWidget {
  final double value;
  final double min;
  final double max;
  final int divisions;
  ...
  @override
  _SliderUsdState createState() => _SliderUsdState();
}

class _SliderUsdState extends State<SliderUsd> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            '${NumberFormat('#,###,###').format(_sliderValue)}  USD',
