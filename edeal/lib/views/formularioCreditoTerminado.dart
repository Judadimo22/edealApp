...
class FormularioCreditoTerminado extends StatefulWidget {
  final String token;

  FormularioCreditoTerminado ({required this.token, Key? key}) : super(key: key);

  @override
  State<FormularioCreditoTerminado > createState() => _FormularioCreditoTerminadoState();
}

class _FormularioCreditoTerminadoState extends State<FormularioCreditoTerminado > {
  late String userId;
